  ...
  return (
    <div className="p-4 md:p-8 max-w-xl mx-auto animate-fade-in">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-bold text-zinc-800">Create Task</h1>
      </div>

      {error && (
        <div className="mb-5 p-3.5 bg-rose-50 border border-rose-200 text-rose-700 rounded-xl text-sm" role="alert">
          {String(error)}
        </div>
      )}
